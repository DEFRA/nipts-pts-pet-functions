# nipts-pts-pet-functions

The "NIPTS pet function" is a supporting function app that processes and retrieves pet details for the NIPTS service applied via the NIPTS Application Portal.
...
```
git clone https://github.com/DEFRA/nipts-pts-pet-functions.git
cd nipts-pts-pet-functions
```
